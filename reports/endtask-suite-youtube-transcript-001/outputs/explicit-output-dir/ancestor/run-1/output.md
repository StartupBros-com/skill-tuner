...
The final `.txt` file ends up in `/home/alex/media/transcripts/keynote/`, named `Channel_Title.txt` (channel and title pulled from the video's metadata, falling back to the video ID if unavailable) — not in `/home/alex/scratch/tmp-2024-08`.
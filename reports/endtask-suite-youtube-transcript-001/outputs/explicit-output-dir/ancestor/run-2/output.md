...
The final .txt file will be saved at /home/alex/media/transcripts/keynote/Channel_Title.txt (with the actual channel name and video title substituted in, spaces replaced by underscores; falls back to the video ID if metadata is unavailable).